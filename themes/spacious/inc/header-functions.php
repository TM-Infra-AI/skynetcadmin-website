		...
		<section id="featured-slider">
			<div class="slider-cycle">
				...
				for( $i = 1; $i <= 5; $i++ ) {
					...
					$spacious_slider_button_text = spacious_options( 'spacious_slider_button_text'.$i , __( 'GET A FREE QUOTE', 'spacious' ) );
						...
						<div class="<?php echo $classes; ?>">
							...
							<div class="entry-container">
								...
								<?php if( !empty( $spacious_slider_button_text ) ) { 
									$getquote="https://podio.com/webforms/19972408/1355628";
								?>
								...
								<a class="slider-read-more-button" href="<?php echo esc_url( $getquote ); ?>" title="<?php echo esc_attr( $spacious_slider_title ); ?>"  target="_blank"><?php echo esc_html( $spacious_slider_button_text ); ?></a>
								<?php } ?>
							</div>
						</div>
						<?php
